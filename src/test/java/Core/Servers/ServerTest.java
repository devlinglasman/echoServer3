...
public class ServerTest {
    ...
    private final String clientMessage = "Hello World!\n";
...
//        IOHelper stdIO = new IOHelper("");
//        IOHelper socketIOclient = new IOHelper(clientMessage);
//
...
//        server.start();
//
//        assertEquals(Message.echoIntro + clientMessage, socketIOclient.getOutput());
//    }
}
